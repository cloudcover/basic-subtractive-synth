...
void MixerView::paint (juce::Graphics& g)
{
    ...
    g.drawText("1", 50, 340, 20, 20, juce::Justification::centredTop);
    g.drawText("2", 90, 340, 20, 20, juce::Justification::centredTop);
    g.drawText("3", 130, 340, 20, 20, juce::Justification::centredTop);
    
    juce::Rectangle<float> area(25, 25, 150, 350);
